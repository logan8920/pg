...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <x-pageheading :heading="'Mode List'" :navigation="['Mode', 'List']" :description="$description ?? null" />
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex float-right justify-content-between py-3 w-100">
                ...
                @can('mode-create')
                    <button class="btn btn-primary" data-href="{{ route('mode.store') }}" type="button" id="openOffcanvas"><i
    ...
    <div class="offcanvas w-25 overflow-auto" id="myOffcanvas">
        <div class="offcanvas-header">
            <h4 class="text-black-50">Add New Mode</h4>
        ...
        <div class="offcanvas-body">
            <form autocomplete="off" action="" id="regForm" method="post" validate>
                ...
                <div class="form-group">
                    <label class="text-black-50" for="name">Mode Name <span class="text-danger">*</span></label>
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control after-parent" id="name"
                            placeholder="Enter Mode Name..." required>
                    </div>
                </div>

                <div class="form-group">
                    <label class="text-black-50" for="description">Mode Description<span
                            class="text-danger"></span></label>
                    <textarea name="description" rows="10" id="description" class="form-control w-100"
    ...
    <script>
        ...
        openBtn && openBtn.addEventListener('click', () => {
            ...
            offcanvas.querySelector('form').description.innerHTML = '';
            offcanvas.querySelector('.offcanvas-header h4').textContent = "Add New Mode";
            ...
            },
            {
                ...
                render: function(e, t, a, s) {
                    ...
                    return `<div style="white-space: nowrap;" class="main-edit-btn text-center">
                                @can('mode-update')
                                 <a href="/mode/${a.id}" data-bs-toggle="tooltip" onclick="openEditModal(${a.id},this,event)" title="edit">
                                    <i class="fas fa-edit btn btn-primary btn-sm"></i>
                                </a>
                                @endcan
                                @can('mode-destroy')
                                <a href="/mode/${a.id}/destroy" data-bs-toggle="tooltip" data-id="${a.id}" onclick="deleteConfirmation(this,event)" title="Delete">
    ...
    @can('mode-edit')
        <script>
            function openEditModal(id, ele, event) {
                ...
                h4.textContent = `Edit Mode | ${tableData[id].name}`;
                ...
                form.description.innerHTML = tableData[id].description;
            }
        </script>
    @endcan
