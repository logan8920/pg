...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <x-pageheading :heading="$heading" :navigation="['User Managment', 'Role']" :description="$description ?? null" />

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header d-flex float-right justify-content-between py-3 w-100">
                <h6 class="align-content-around font-weight-bold justify-content-lg-between m-0 text-primary">List of Role
                </h6>
                <button class="btn btn-primary" data-href="{{ route('role.store') }}" type="button" id="openOffcanvas"><i
    ...
    <div class="offcanvas w-25" id="myOffcanvas">
        <div class="offcanvas-header">
            <h4 class="text-black-50">Add New Role</h4>
        ...
        <div class="offcanvas-body">
            <form autocomplete="off" action="" id="regForm" method="post" validate>
                ...
                <div class="form-group">
                    <label class="text-black-50" for="role_title">Role Title <span class="text-danger">*</span></label>
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control after-parent" id="role_title"
                            placeholder="Enter title..." required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="text-black-50" for="role_description">Description</label>
                    <textarea name="description" rows="10" id="role_description" class="form-control after-parent"
    ...
    <script>
        ...
        openBtn && openBtn.addEventListener('click', () => {
            ...
            offcanvas.querySelector('.offcanvas-header h4').textContent = "Add New Role";
...
@section('js')
            ...
            },
            {
                ...
                render: function(e, t, a, s) {
                    ...
                    return `<div style="white-space: nowrap;" class="main-edit-btn text-center">
                                @can('role-edit')
                                 <a href="${window.baseUrl}user-management/role/${a.id}" data-bs-toggle="tooltip" onclick="openEditModal(${a.id},this,event)" title="edit">
                                    <i class="fas fa-edit btn btn-primary btn-sm"></i>
                                </a>
                                @endcan
                                @can('role-destroy')
                                <a href="${window.baseUrl}user-management/role/${a.id}/destroy" data-bs-toggle="tooltip" data-id="${a.id}" onclick="deleteConfirmation(this,event)" title="Delete">
                                    <i class="fas fa-trash-alt btn btn-danger btn-sm"></i>
                                </a>
                                @endcan
                                 @can('role-destroy')
                                <a href="${window.baseUrl}user-management/role/${a.id}/assign-permission" data-bs-toggle="tooltip" title="Assign Permission">
                                    <i class="fas fa-user btn btn-warning btn-sm"></i>
                                </a>
                                @endcan
                           </div>`;
                },
    ...
    <script>
        ...
        function openEditModal(id, ele, event) {
            ...
            h4.textContent = `Edit Role | ${tableData[id].name}`;
